        ...
        mounted() {
            this.audio.addEventListener("ended", () => {
                if (this.token_for_sound) {
                    let voice = window?.JLToken?.voice_content_one + this.token_for_sound.token_letter + this.token_for_sound.token_number + window?.JLToken?.voice_content_two + this.token_for_sound.counter.name
