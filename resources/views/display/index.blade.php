                    ...
                    <table class="table table-dark" style="justify-content:center;margin-bottom:0;">
                        ...
                        <tbody>
                            <tr v-for="token in tokens">
                                ...
                                <td v-if="token?.call_status_id != {{CallStatuses::SERVED}} &&  token?.call_status_id != {{CallStatuses::NOSHOW}}"
                                ...
                                <td v-if="!token" style="font-size:45px;padding-left:30px;font-weight:bold;line-height:1.2;color:#50C878">{{__('messages.display.nil')}}</td>
                            </tr>                            
                        </tbody>
                    </table>
                </div>                
