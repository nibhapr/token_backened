...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns noprint ">
            ...
            <nav class="navbar-main navbar-color nav-collapsible sideNav-lock">
                <div class="nav-wrapper">
                    ...
                    <ul class="dropdown-content" id="profile-dropdown">
                        @can('view profile')
                        <li><a class="grey-text text-darken-1" href="{{route('profile')}}"><i class="material-icons">person_outline</i> {{__('messages.common.profile')}}</a></li>
                        <li class="divider"></li>
                        @endcan
                        <li><a class="grey-text text-darken-1" href="{{route('logout')}}"><i class="material-icons">keyboard_tab</i> {{__('messages.common.logout')}}</a></li>
                    </ul>
    ...
    <script src="{{ asset('app-assets/app.js') }}"></script>
