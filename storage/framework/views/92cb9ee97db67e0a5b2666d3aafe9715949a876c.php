        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title col s5"><b><?php echo e(__('messages.counter_page.edit counter')); ?></b></h5>
            ...
            <div class="row">
                <div class="col  s12 m8  offset-m2">
                    <div class="card-panel">
                        <div class="row">
                            <form id="counter_form" method="post" action="<?php echo e(route('counters.update',[$counter->id])); ?>">
                                ...
                                <div class="row">
                                    <div class="row form_align">
                                        <div class="input-field col s12">
                                            ...
                                            <input id="name" name="name" type="text" value="<?php echo e($counter->name); ?>" data-error=".name">
                                            <div class="name">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Milan\Desktop\Work\token_backend\resources\views/counter/edit.blade.php ENDPATH**/ ?>