        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title col s5"><b><?php echo e(__('messages.service_page.edit service')); ?></b></h5>
            ...
            <div class="row">
                <div class="col  s12 m8  offset-m2">
                    <div class="card-panel">
                        <div class="row">
                            <form id="service_form" method="post" action="<?php echo e(route('services.update',[$service->id])); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s6">
                                            ...
                                            <input id="letter" name="letter" type="text" value="<?php echo e($service->letter); ?>" data-error=".letter">
                                            <div class="letter">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="start_number" name="start_number" type="number" value="<?php echo e($service->start_number); ?>" data-error=".start_number">
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s3">
                                            <select name="ask_name" id="ask_name" data-error=".ask_name" onchange="enableRequired()">
                                                <option value="0" <?php if($service->ask_name==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->ask_name==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                        ...
                                        <div class="input-field col s3">
                                            <select name="name_required" id="name_required" data-error=".name_required">
                                                <option value="0" <?php if($service->name_required==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->name_required==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                        ...
                                        <div class="input-field col s3">
                                            <select name="ask_email" id="ask_email" data-error=".ask_email" onchange="enableRequired()">
                                                <option value="0" <?php if($service->ask_email==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->ask_email==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                        ...
                                        <div class="input-field col s3">
                                            <select name="email_required" id="email_required" data-error=".email_required">
                                                <option value="0" <?php if($service->email_required==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->email_required==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s3">
                                            <select name="ask_phone" id="ask_phone" data-error=".ask_phone" onchange="enableRequired()">
                                                <option value="0" <?php if($service->ask_phone==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->ask_phone==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                        ...
                                        <div class="input-field col s3">
                                            <select name="phone_required" id="phone_required" data-error=".phone_required">
                                                <option value="0" <?php if($service->phone_required==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->phone_required==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                        ...
                                        <div class="input-field col s6">
                                            <select name="sms" id="sms" data-error=".sms" onchange="changeSMS()">
                                                <option value="0" <?php if($service->sms_enabled==0): ?> selected <?php endif; ?>>No</option>
                                                <option value="1" <?php if($service->sms_enabled==1): ?> selected <?php endif; ?>>Yes</option>
                                            </select>
                                    ...
                                    <div id="sms_tab">
                                        <div class="row form_align">
                                            <h3 style="margin-left: 16px;"><?php echo e(__('messages.settings.SMS Settings')); ?></h3>
                                        </div>
                                        <div class="row form_align">
                                            <div class="input-field col s6">
                                                <select name="optin_message" id="optin_message" data-error=".optin_message" onchange="changeOptinMessage()">
                                                    <option value="0" <?php if($service->optin_message_enabled== 0): ?> selected <?php endif; ?>>No</option>
                                                    <option value="1" <?php if($service->optin_message_enabled== 1): ?> selected <?php endif; ?>>Yes</option>
                                                </select>
                                            ...
                                            <div class="input-field col s6">
                                                <select name="call_message" id="call_message" data-error=".call_message" onchange="changeCallMessage()">
                                                    <option value="0" <?php if($service->call_message_enabled== 0): ?> selected <?php endif; ?>>No</option>
                                                    <option value="1" <?php if($service->call_message_enabled== 1): ?> selected <?php endif; ?>>Yes</option>
                                                </select>
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6" style="margin-top: 0;" id="optin_message_tab">
                                                <textarea id="optin_message_format" name="optin_message_format" class="materialize-textarea" data-error=".optin_message_format"><?php if($service->optin_message_format): ?><?php echo e($service->optin_message_format); ?> <?php else: ?> Your token number is '$token_number$'. You are #$position$ in the '$service_name$' queue <?php endif; ?></textarea>
                                            ...
                                            <div class="input-field col s6" style="margin-top: 0; float: right;" id="call_message_tab">
                                                <textarea id="call_message_format" name="call_message_format" class="materialize-textarea" data-error=".call_message_format"><?php if($service->call_message_format): ?><?php echo e($service->call_message_format); ?> <?php else: ?> Your token number '$token_number$' is next to see to '$service_name$' queue <?php endif; ?></textarea>
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6">
                                                <select name="noshow_message" id="noshow_message" data-error=".noshow_message" onchange="changeNoshowMessage()">
                                                    <option value="0" <?php if($service->noshow_message_enabled== 0): ?> selected <?php endif; ?>>No</option>
                                                    <option value="1" <?php if($service->noshow_message_enabled== 1): ?> selected <?php endif; ?>>Yes</option>
                                                </select>
                                            ...
                                            <div class="input-field col s6">
                                                <select name="completed_message" id="completed_message" data-error=".completed_message" onchange="changeCompletedMessage()">
                                                    <option value="0" <?php if($service->completed_message_enabled== 0): ?> selected <?php endif; ?>>No</option>
                                                    <option value="1" <?php if($service->completed_message_enabled== 1): ?> selected <?php endif; ?>>Yes</option>
                                                </select>
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6" style="margin-top: 0;" id="noshow_message_tab">
                                                <textarea id="noshow_message_format" name="noshow_message_format" class="materialize-textarea" data-error=".noshow_message_format"><?php echo e($service->noshow_message_format ? $service->noshow_message_format : 'Your token number `$token_number$` is marked as no show'); ?></textarea>
                                            ...
                                            <div class="input-field col s6" style="margin-top: 0;float: right;" id="completed_message_tab">
                                                <textarea id="completed_message_format" name="completed_message_format" class="materialize-textarea" data-error=".completed_message_format"><?php echo e($service->completed_message_format ? $service->completed_message_format : 'Thank you for using our service, Have a good day'); ?></textarea>
                                                <label for="completed_message_format"><?php echo e(__('messages.service_page.No Show Message Format')); ?></label>
                                            ...
                                            <div class="row form_align">
                                                <div class="input-field col s6">
                                                    <select name="status_message" id="status_message" data-error=".status_message" onchange="changeStatusMessage()">
                                                        <option value="0" <?php if($service->status_message_enabled== 0): ?> selected <?php endif; ?>>No</option>
                                                        <option value="1" <?php if($service->status_message_enabled== 1): ?> selected <?php endif; ?>>Yes</option>
                                                    </select>
                                            ...
                                            <div id="status_message_tab">
                                                <div class="row form_align">
                                                    <div class="input-field col s6">
                                                        <select name="status_message_positions[]" id="status_message_positions" data-error=".status_message_positions" multiple>
                                                            ...
                                                            <option value="3" <?php if(($service->status_message_positions && in_array('3',$service->status_message_positions)) || !$service->status_message_positions): ?> selected <?php endif; ?>>3</option>
                                                            <option value="5" <?php if($service->status_message_positions && in_array('5',$service->status_message_positions)): ?> selected <?php endif; ?>>5</option>
                                                            <option value="10" <?php if($service->status_message_positions && in_array('10',$service->status_message_positions)): ?> selected <?php endif; ?>>10</option>
                                                            <option value="15" <?php if($service->status_message_positions && in_array('15',$service->status_message_positions)): ?> selected <?php endif; ?>>15</option>
                                                            <option value="20" <?php if($service->status_message_positions && in_array('20',$service->status_message_positions)): ?> selected <?php endif; ?>>20</option>
                                                        </select>
                                                ...
                                                <div class="row form_align">
                                                    <div class="input-field col s6" style="margin-top: 0;">
                                                        <textarea id="status_message_format" name="status_message_format" class="materialize-textarea" data-error=".status_message_format"><?php echo e($service->status_message_format ? $service->status_message_format : ' Your token number `$token_number$` is at #$position$ in the `$service_name$` queue'); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Milan\Desktop\Work\token_backend\resources\views/service/edit.blade.php ENDPATH**/ ?>