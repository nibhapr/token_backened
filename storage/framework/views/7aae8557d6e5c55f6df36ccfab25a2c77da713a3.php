    ...
    <form class="tabs-wrap">
        <div class="tab" id="tab1content">
            <div class="form-group col-sm-8" :class="{'has-error' : errors['purchase_code']}">
                <a href="" target="_blank" style="float: right;">How to get codecanyon purchase code</a>
...
<div class="tabs tabs-full" v-if="set_env_page">
    <div v-if="finished">
        ...
        <div class="buttons">
            <a href="<?php echo e(route('login')); ?>" class="button">Click here to exit</a>
        </div>
    </div>
    <div v-if="!finished">
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('b-script'); ?>
<script>
    window.JLToken = {
        
        requirements_url: "<?php echo e(route('requirements')); ?>",
        permissions_url: "<?php echo e(route('permissions')); ?>",
        set_env_url: "<?php echo e(route('set-env')); ?>",
        test_connection_url: "<?php echo e(route('test-connection')); ?>",
        is_sub_directory: "<?php echo e($sub_directory); ?>"
    }
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/milan/Desktop/Work/token_backened/resources/views/vendor/installer/installer.blade.php ENDPATH**/ ?>